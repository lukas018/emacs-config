...
(package! helm-bibtex)
;; Pin this for now since org-roam v2 is out
...
I usually don't enjoy web-development, I even found React.js do be a bit lack luster, but Vue.js have actually changed my mind on the subject.
However, the vue-mode in emacs is not currently being maintained.
But thanks to some crafty people [[https://github.com/AdamNiederer/vue-mode/issues/109][here]] we can replicate it using polymode instead
...
(use-package! helm-bibtex
  ...
  (setq
   ...
   bibtex-completion-bibliography (nconc '("~/org/ref/references.bib") (file-expand-wildcards "~/Documents/data-rapport/bibliographies/*.bib"))
   ))
#+end_src
...
* MISC
Some small fixes I need right now
#+begin_src emacs-lisp
(add-to-list 'org-latex-classes
             '("foireport" "\\documentclass{foireport}"))
